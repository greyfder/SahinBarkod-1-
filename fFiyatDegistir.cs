...
// Type: SahinBarkod_1_.fFiyatDegistir
...
{
  public class fFiyatDegistir : Form
  {
    ...
    public fFiyatDegistir() => this.InitializeComponent();

    private void fFiyatDegistir_Load(object sender, EventArgs e)
    {
      this.tEskiFiyat.Text = this.eskifiyat;
      this.tYeniFiyat.Focus();
    }

    private void bstandart1_Click(object sender, EventArgs e)
    {
      if (!(this.tYeniFiyat.Text != string.Empty))
        return;
      ((Form1) Application.OpenForms["Form1"]).yenifiyat = Convert.ToDouble(this.tYeniFiyat.Text);
      this.Close();
    }

    private void bstandart1_Click_1(object sender, EventArgs e)
    {
      ((Form1) Application.OpenForms["Form1"]).yenifiyat = Convert.ToDouble(this.tEskiFiyat.Text);
      this.Close();
    }
    ...
    private void bNx_Click(object sender, EventArgs e)
    {
      ...
      if (button.Text == ",")
      {
        if (this.tYeniFiyat.Text.Count<char>((Func<char, bool>) (x => x == ',')) >= 1)
          return;
        this.tYeniFiyat.Text += button.Text;
      }
      else if (button.Text == "<")
      {
        if (this.tYeniFiyat.Text.Length <= 0)
          return;
        this.tYeniFiyat.Text = this.tYeniFiyat.Text.Substring(0, this.tYeniFiyat.Text.Length - 1);
      }
      else
        this.tYeniFiyat.Text += button.Text;
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.tYeniFiyat = new tnumeric();
      this.tEskiFiyat = new tnumeric();
      ...
      this.bstandart1.Location = new Point(12, 182);
      ...
      this.bstandart1.Click += new EventHandler(this.bstandart1_Click_1);
      ...
      this.btamam.Location = new Point(218, 182);
      ...
      this.btamam.Click += new EventHandler(this.bstandart1_Click);
      this.lstandart2.AutoSize = true;
      this.lstandart2.Font = new Font("Microsoft Sans Serif", 12f);
      this.lstandart2.ForeColor = Color.DarkCyan;
      this.lstandart2.Location = new Point(27, 94);
      this.lstandart2.Name = "lstandart2";
      this.lstandart2.Size = new Size(98, 25);
      this.lstandart2.TabIndex = 3;
      this.lstandart2.Text = "Yeni Fiyat";
      this.tYeniFiyat.BackColor = Color.White;
      this.tYeniFiyat.Font = new Font("Microsoft Sans Serif", 18.15652f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.tYeniFiyat.Location = new Point(12, 122);
      this.tYeniFiyat.Name = "tYeniFiyat";
      this.tYeniFiyat.Size = new Size(383, 40);
      this.tYeniFiyat.TabIndex = 0;
      this.tYeniFiyat.TextAlign = HorizontalAlignment.Right;
      this.tEskiFiyat.BackColor = Color.White;
      this.tEskiFiyat.Font = new Font("Microsoft Sans Serif", 18.15652f, FontStyle.Regular, GraphicsUnit.Point, (byte) 162);
      this.tEskiFiyat.Location = new Point(12, 51);
      this.tEskiFiyat.Name = "tEskiFiyat";
      this.tEskiFiyat.ReadOnly = true;
      this.tEskiFiyat.Size = new Size(383, 40);
      this.tEskiFiyat.TabIndex = 3;
      this.tEskiFiyat.TabStop = false;
      this.tEskiFiyat.TextAlign = HorizontalAlignment.Right;
      this.lstandart1.AutoSize = true;
      this.lstandart1.Font = new Font("Microsoft Sans Serif", 12f);
      this.lstandart1.ForeColor = Color.DarkCyan;
      this.lstandart1.Location = new Point(29, 23);
      this.lstandart1.Name = "lstandart1";
      this.lstandart1.Size = new Size(96, 25);
      ...
      this.tableLayoutPanel8.Location = new Point(10, 265);
      ...
      this.ClientSize = new Size(415, 665);
      ...
      this.Controls.Add((Control) this.tYeniFiyat);
      this.Controls.Add((Control) this.tEskiFiyat);
      this.Controls.Add((Control) this.lstandart1);
      this.FormBorderStyle = FormBorderStyle.None;
      this.Name = nameof (fFiyatDegistir);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = nameof (fFiyatDegistir);
      this.Load += new EventHandler(this.fFiyatDegistir_Load);
